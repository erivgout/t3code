// This file mostly exists because we want dev mode to say "Kalsec Code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Kalsec Code (Dev)" : "Kalsec Code (Alpha)";
